...
def get_friends_listening_now(user_id: str) -> list[dict]:
    ...
    # "Listening now" means today — start of the current UTC day, not a
    # rolling 24h window (which would keep yesterday-evening listens around
    # until the same time the next morning).
